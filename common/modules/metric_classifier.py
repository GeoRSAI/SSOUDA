...
__all__ = ['Metric_Classifier']


class Metric_Classifier(nn.Module):
    ...
    def __init__(self, backbone: nn.Module, num_classes: int, bottleneck: Optional[nn.Module] = None,
        ...
        super(Metric_Classifier, self).__init__()
        ...
        if head is None:
            self.embedding_fc = nn.Linear(self._features_dim, 128)
...
class Metric_ImageClassifier(Metric_Classifier):
    pass
