...
class CompleteLogger:
    ...
    def __init__(self, root, phase='train'):
        ...
        self.retrieval_directory = os.path.join(self.root, "retrieval")
        self.predict_directory = os.path.join(self.root, "predict")
        # print('执行了代码')
        self.epoch = 0
        ...
        os.makedirs(self.retrieval_directory, exist_ok=True)
        os.makedirs(self.predict_directory, exist_ok=True)
